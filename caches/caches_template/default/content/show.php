...
<p style="text-align: center;">
  <iframe height=498 width=510 src="<?php echo $videourl;?>" frameborder=0 allowfullscreen></iframe>
<p>
          ...
          <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=1ed4cf4e2c1f8c97616e98f3fb23abd5&action=relation&catid=%24catid&order=id+DESC&relation=%24relation&keywords=%24rs%5Bkeywords%5D&num=5\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'relation')) {$data = $content_tag->relation(array('catid'=>$catid,'order'=>'id DESC','relation'=>$relation,'keywords'=>$rs[keywords],'limit'=>'5',));}?>
              <?php if($data) { ?>
                <div class="related">
