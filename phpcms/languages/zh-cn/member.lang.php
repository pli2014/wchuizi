...
$LANG['sina_login_notice'] = '使用新浪微博连接登录微锤子,将精彩内容分享到新浪微博。';
$LANG['qq_login_notice'] = '使用腾讯微博连接登录微锤子,将精彩内容分享到腾讯微博。';
$LANG['snda_login_notice'] = '使用用盛大连接登录微锤子,轻松使用盛大所有服务。';
